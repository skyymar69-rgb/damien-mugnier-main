...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Carrelage grand format, marbre, pierre naturelle, terrasses & rénovation." },
      { property: "og:image", content: marbreSol },
    ],
    links: [{ rel: "canonical", href: "https://damienmugnier.fr/services" }],
  }),
    ...
    <>
      <section className="bg-primary py-20 text-primary-foreground md:py-28">
        <div className="container-prose">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-5xl text-balance md:text-6xl">
            Six expertises au service de vos projets <em className="text-accent not-italic">d'exception</em>.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-primary-foreground/80">
            De la salle de bains en marbre au mur en pierre naturelle, chaque chantier est mené avec la même exigence.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="container-prose grid gap-10 md:grid-cols-2">
          {offers.map((o) => (
            <article key={o.title} className="group overflow-hidden rounded-2xl border border-border bg-card transition-all hover:shadow-xl">
