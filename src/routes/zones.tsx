...
export const Route = createFileRoute("/zones")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Beauvallon, Givors, Brignais, Mornant, Vienne, Lyon Sud." },
    ],
    links: [{ rel: "canonical", href: "https://damienmugnier.fr/zones" }],
  }),
  component: ZonesPage,
});

const zones = [
  { city: "Beauvallon", cp: "69700", desc: "Notre commune historique. Interventions prioritaires et rapides." },
  ...
  { city: "Mornant", cp: "69440", desc: "Maisons de caractère, plages de piscine, terrasses bois." },
  { city: "Vienne", cp: "38200", desc: "Carrelage grand format, façades pierre, escaliers." },
  { city: "Lyon Sud", cp: "69", desc: "Appartements et hôtels particuliers, finitions exigeantes." },
];
    ...
    <>
      <section className="bg-primary py-20 text-primary-foreground md:py-28">
        <div className="container-prose">
          <p className="text-sm font-medium uppercase tracking-widest text-accent">Zones d'intervention</p>
          ...
          <p className="mt-6 max-w-2xl text-lg text-primary-foreground/80">
            Basé à Beauvallon (69700), nous intervenons dans un rayon de 40 km autour de Lyon Sud pour des projets résidentiels haut de gamme.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="container-prose grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {zones.map((z) => (
            <article key={z.city} className="group rounded-2xl border border-border bg-card p-7 transition-all hover:border-accent/60 hover:shadow-lg">
        ...
        <div className="container-prose mt-14 text-center">
          <Link to="/contact" className="inline-flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-sm font-semibold text-primary-foreground hover:shadow-xl">
