...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Artisan passionné, exigeant, garant d'un travail soigné et durable." },
      { property: "og:image", content: murPierre },
    ],
    links: [{ rel: "canonical", href: "https://damienmugnier.fr/a-propos" }],
  }),
  component: AboutPage,
});

const values = [
  { icon: Award, title: "Exigence", text: "Chaque détail compte. La qualité prime sur la quantité." },
  { icon: ShieldCheck, title: "Garantie décennale", text: "Vous êtes protégés. Nos chantiers sont assurés." },
  { icon: Sparkles, title: "Matériaux nobles", text: "Marbre, pierre, grès cérame haut de gamme uniquement." },
  { icon: Users, title: "Un interlocuteur unique", text: "Damien suit personnellement chaque projet, du devis à la livraison." },
];
    ...
    <>
      <section className="bg-primary py-20 text-primary-foreground md:py-28">
        <div className="container-prose grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            <p className="text-sm font-medium uppercase tracking-widest text-accent">Notre histoire</p>
            ...
            <p className="mt-6 text-lg text-primary-foreground/85">
              Carreleur et maçon de formation, Damien Mugnier s'est spécialisé dans le carrelage grand format,
              le marbre et la pierre naturelle. Basé à Beauvallon (69700), il accompagne particuliers et architectes
              du Sud-Ouest lyonnais sur des projets exigeants.
            </p>
          </div>
