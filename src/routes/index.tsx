...
import { ArrowRight, CheckCircle2, Phone, Star, Sparkles, Hammer, Home as HomeIcon } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      { rel: "canonical", href: "https://damienmugnier.fr/" },
      { rel: "preload", as: "image", href: spaNuit },
    ],
    scripts: [
      {
        type: "application/ld+json",
        children: JSON.stringify(homeServiceJsonLd),
      },
    ],
  }),
  component: HomePage,
...
const services = [
  {
    ...
    description: "Pose maîtrisée de dalles 60×120, 120×120 et 120×240 cm. Marbre, grès cérame effet pierre, finitions invisibles.",
  },
  {
    icon: Hammer,
    title: "Maçonnerie & pierre naturelle",
    description: "Murs en pierre, murets, terrasses, escaliers. Travail traditionnel pour un résultat authentique et durable.",
  },
  {
    icon: HomeIcon,
    title: "Rénovation complète",
    description: "Salles de bains, cuisines, espaces de vie. De la dépose à la finition, un seul interlocuteur.",
  },
];
        ...
        <div className="container-prose relative grid gap-12 py-24 md:grid-cols-12 md:py-32 lg:py-40">
          <div className="md:col-span-8 animate-slide-up">
            ...
            <h1 className="mt-6 font-display text-5xl leading-[1.05] text-balance md:text-7xl">
              L'art du carrelage <span className="italic text-gradient-gold">grand format</span> & de la pierre.
            </h1>
            <p className="mt-6 max-w-2xl text-lg text-primary-foreground/85 md:text-xl">
              Damien Mugnier conçoit et réalise des intérieurs et extérieurs haut de gamme :
              marbre, dalles XXL, terrasses, piscines, maçonnerie en pierre naturelle.
              Travail soigné, garantie décennale.
            </p>
            ...
            <div className="mt-12 flex flex-wrap gap-x-8 gap-y-3 text-sm text-primary-foreground/75">
              {["Garantie décennale", "Devis sous 48h", "Chantiers 10k€ – 50k€", "Beauvallon · Givors · Brignais"].map((t) => (
      ...
      <section className="py-24 md:py-32">
        <div className="container-prose">
          <div className="max-w-2xl">
            <p className="text-sm font-medium uppercase tracking-widest text-accent">Savoir-faire</p>
            <h2 className="mt-3 font-display text-4xl text-balance md:text-5xl">
              Trois métiers, une exigence : la <em className="text-accent not-italic">finition parfaite</em>.
            </h2>
          </div>
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {services.map((s, i) => (
              <article
                ...
                className="hover-lift group flex flex-col gap-4 rounded-2xl border border-border bg-card p-8 animate-fade-in"
              >
        ...
        <div className="container-prose">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-xl">
              <p className="text-sm font-medium uppercase tracking-widest text-accent">Nos réalisations</p>
              <h2 className="mt-3 font-display text-4xl text-balance md:text-5xl">
                Des chantiers pensés comme des <em className="text-accent not-italic">pièces uniques</em>.
              </h2>
            </div>
            <Link
              to="/realisations"
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-12">
            <figure className="group relative overflow-hidden rounded-2xl md:col-span-7 md:row-span-2">
              <img
                src={spaNuit}
            ...
            <figure className="group relative overflow-hidden rounded-2xl md:col-span-5">
              <img
                src={wcMarbre}
        ...
        <div className="container-prose grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div>
            ...
            <ol className="mt-10 space-y-7">
              {[
                { n: "01", t: "Visite & écoute", d: "Rendez-vous sur site, prise de cotes, conseils techniques et esthétiques." },
                { n: "02", t: "Devis détaillé", d: "Proposition claire, transparente et chiffrée sous 48h." },
                { n: "03", t: "Réalisation soignée", d: "Un seul interlocuteur, chantier propre, respect des délais." },
                { n: "04", t: "Livraison & garantie", d: "Réception minutieuse, garantie décennale, suivi long terme." },
              ].map((s) => (
      ...
      <section className="bg-primary py-20 text-primary-foreground md:py-24">
        <div className="container-prose flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-accent-foreground hover:shadow-xl">
              Demander un devis <ArrowRight className="h-4 w-4" />
            </Link>
            <a href="tel:+33628453288" className="inline-flex items-center gap-2 rounded-full border border-primary-foreground/30 px-7 py-3.5 text-sm font-medium hover:bg-primary-foreground/10">
              <Phone className="h-4 w-4" /> 06 28 45 32 88
            </a>
          </div>
        </div>
